...
import CardProps from "./../../2-Core/Surface/Surface.js"
...
<Preview>
<Story name="Full Usage">
    <Card elevation={4} margin={8} style={{maxWidth:400}} >
      <Card.Header
        left={props => (
          <Avatar.Image
            {...props}
        ...
        right={props => (
          <IconButton icon="more_vert" onPress={()=>console.log("Card Header Right Button")}  />
        )}
        title="deneme"
      ...
      <Card.Content>
        ...
        <Text variant="body2" lineBreakMode="clip">
          ...
          aliquid. Obcaecati autem doloribus sequi error expedita architecto rem
          fugit non!
        </Text>
      </Card.Content>
      <Card.Actions>
        <Button onPress={()=>console.log("clicked")}>Action 1</Button>
        <Button onPress={()=>console.log("clicked")}>Action 2</Button>
      </Card.Actions>
    </Card>
</Story>
</Preview>    
...
<Preview>
<Story name="Inline Left Usage" >
      <Card
        elevation={1}
        margin={8}
       style={{maxWidth:400}} direction="row"
        alignContent="center"
        alignItems="center">
        ...
        <View style={{flex: 1,flexDirection:"column", flexWrap: 'wrap'}}>
          ...
          <Card.Actions>
            <IconButton icon="thumb_up" onPress={() => {}} />
...
<Preview>
<Story name="Inline Right Usage" >
      <Card
        elevation={1}
        margin={8}
       style={{maxWidth:400}} direction="row-reverse"
        alignContent="center"
        alignItems="center">
        <View style={{minWidth: '30%', justifyContent: 'center'}}>
          <Image

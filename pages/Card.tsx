    ...
    <ScrollView>
      <Card elevation={4} margin={8}>
        ...
        <Image
          source={{
            uri:
              'https://images.unsplash.com/photo-1558980394-dbb977039a2e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=480&q=50',
            cache: 'force-cache',
          }}
        />
        {cardContent}
...
const cardContent = (
  <Card.Content>
    ...
    <Text variant="body2" lineBreakMode="clip">
      ...
      ratione enim error neque iure? Eos inventore autem earum aliquid.
      Obcaecati autem doloribus sequi error expedita architecto rem fugit non!
    </Text>
  </Card.Content>
);
const cardContent2 = (
  <Card.Content>
    <Text variant="h6" weight="500" transform="capitalize" gutterBottom={4}>
      deneme
    </Text>
    <Text variant="subtitle2" weight="300" contrast={1} transform="capitalize">

...
const TextFieldOutlined = ({ defaultValue, label, value, error, success, warning, count, Left, Right, onChange, disabled, ripple, helperText, bottomWrapperStyle, clearButtonMode, placeholder, min, max, ...rest }) => {
    ...
    let borderWidth = disabled ? 1.5 : 1, variantStyle = {
        ...
        paddingTop: 0,
    }, labelPosArr = [16, -10], labelFontSize = labelAnim.interpolate({
        inputRange: [0, 1],
        outputRange: [16, 12],

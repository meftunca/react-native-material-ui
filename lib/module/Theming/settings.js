...
export const Provider = ({ children }) => {
    ...
    const onToggleAlert = (status) => setAlertData({ ...alertData, isOpen: status });
    const onToggleSnackbar = (status = !snackbarData.isOpen) => setSnackbarData({ ...snackbarData, isOpen: status });
    ...
    return (React.createElement(SettingsContext.Provider, { value: value },
        children,
        alertData && (React.createElement(Alert, Object.assign({}, alertData, { onDismiss: () => onToggleAlert(false) }))),
        snackbarData && (React.createElement(Snackbar, Object.assign({}, snackbarData, { onDismiss: () => onToggleSnackbar(false) })))));
};
...
export const useSnackbar = () => {
    const { setSnacbar, onToggleSnackbar, isOpenSnacbar } = React.useContext(SettingsContext);
    return {
        setSnacbar,
